//SmallFilesToSequenceFileConverter: A MapReduce program for packaging 
//a collection of small files as a single SequenceFile
package com.ll.MapReduce.ch07.FileInputFormat;
...
public class SmallFilesToSequenceFileConverter extends Configured implements
	...
	public int run(String[] args) throws Exception {
		...
		Job job = null; // 应该使用上面的语句，但是jar包版本不对，所以注释掉了
		if (job == null) {
			return -1;
		}
